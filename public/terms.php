...
<head>
    ...
    <title>Terms & Conditions - UK London International Award Board</title>
    ...
    <main class="gov-width-container">
        <div class="gov-grid-row">
            <div class="gov-grid-column-two-thirds">
                ...
                <p>Welcome to the UK London International Award Board. Please read these terms and conditions carefully before enrolling or using our learning management system.</p>
                ...
                <p style="background-color: #fafcff; padding: 15px; border-left: 5px solid #002F6C; font-size:16px;">
                    <strong>IMPORTANT NOTICE:</strong> All certifications, transcripts, and diplomas issued through this portal are proprietary certificates issued by the UK London International Award Board itself. These certifications do not represent regulatory, statutory, or government-mandated degree approvals.
                </p>

                ...
                <div class="flex flex-wrap items-center justify-between">
                    <div class="w-full lg:w-auto">
                        <h3
                            ...
                            Are you looking for your dream Home?</h3>
                        <p class="text-secondary leading-[1.5] tracking-[0.03em] mb-10">Get personalized property
                            recommendations delivered straight to your inbox.</p>
                        <form id="mc-form" action="{{ route('lead.store') }}" method="POST" class="relative w-full">
                            @csrf
                            <input id="mc-email"
                                ...
                                type="text" placeholder="Enter Phone Number,WhatsApp's or Email here...">

<x-partials.layout :title="'Contact Us'">
    <section
                        ...
                        <div class="grid grid-cols-12 gap-x-[20px] gap-y-[30px]">
                            ...
                            <div class="col-span-12">
                                <textarea
                                    ...
                                    name="message" id="textarea" cols="30" rows="10" placeholder="Message"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 lg:col-span-5 mb-[30px] order-last lg:order-none">
                        <div class="h-[385px] rounded-[6px] overflow-hidden xl:ml-[40px]">
                            <iframe class="w-full h-full"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1805.2610483650271!2d55.280318449999996!3d25.1856098!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6830646a7739%3A0xc40f6798e6190cdf!2sBusiness%20Bay%20-%20Bay%20Square%20-%20Dubai%20-%20United%20Arab%20Emirates!5e0!3m2!1sen!2s!4v1782671493346!5m2!1sen!2s"
            ...
            <div class="grid col-span-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-[30px] mb-[-30px]">
                ...
                <div
                    ...
                    <img class="self-center mr-[20px] sm:mr-[40px] lg:mr-[20px] xl:mr-[40px] sm:mb-[15px] lg:mb-0"
                        src="{{ asset('assets/images/icon/map.png') }}" width="40" height="55" loading="lazy"
                        alt="image icon">
                    <div class="flex-1">
                        <h4
                        ...
                        <p class="font-light text-[18px] lg:max-w-[230px]">{{ $global_setting->address }}</p>
                    </div>
                </div>
                ...
                <div
                    class="flex hover:drop-shadow-[0px_16px_10px_rgba(0,0,0,0.1)] hover:bg-[#F5F9F8] transition-all p-[20px] xl:p-[35px] rounded-[8px] mb-[30px] group">
                    <img class="self-center mr-[20px] sm:mr-[40px] lg:mr-[20px] xl:mr-[40px] sm:mb-[15px] lg:mb-0"
                        src="{{ asset('assets/images/icon/phone.png') }}" width="46" height="46" loading="lazy"
                        alt="image icon">
                    <div class="flex-1">
                        <h4
                            class="font-lora group-hover:text-secondary group-hover:transition-all leading-none text-[28px] text-primary mb-[10px]">
                            Call us <span class="text-secondary">.</span></h4>
                        <p class="font-light text-[18px] lg:max-w-[230px]"><a
                                href="tel:">{{ $global_setting->phone_number[0] }}</a></p>
                        <p class="font-light text-[18px] lg:max-w-[230px]"><a
                                href="tel:">{{ $global_setting->phone_number[1] }}</a></p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <img class="self-center mr-[20px] sm:mr-[40px] lg:mr-[20px] xl:mr-[40px] sm:mb-[15px] lg:mb-0"
                        src="{{ asset('assets/images/icon/mail.png') }}" width="46" height="52" loading="lazy"
                        alt="image icon">
                    <div class="flex-1">
                        <h4
                            class="font-lora group-hover:text-secondary group-hover:transition-all leading-none text-[28px] text-primary mb-[10px]">
                        ...
                        <p class="font-light text-[18px] lg:max-w-[230px]">
                            <a href="mailto:{{ $global_setting->email_address[0] }}" class="hover:text-secondary">{{
    $global_setting->email_address[0] }}</a>
                            <a href="mailto:{{ $global_setting->email_address[1] }}" class="hover:text-secondary">{{
    $global_setting->email_address[1] }}</a>
                        </p>
                    </div>
                </div>
            </div>
